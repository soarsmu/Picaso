...
class Seq2Seq(nn.Module):
    ...
    def __init__(self, encoder, decoder, config, beam_size=None, max_length=None, \
        ...
        wandb.init(project='single-so-api', config=wandb_config)
    ...
    def forward(self, so_api_ids=None, so_api_mask=None, \
        ...
        if target_ids is not None:
            ...
            out = self.decoder(
                tgt_embeddings, so_api_encoder_output, tgt_mask=attn_mask, \
                memory_key_padding_mask=(1 - so_api_mask).bool())
            ...
            for i in range(so_api_ids.shape[0]):
                context = so_api_encoder_output[:, i:i + 1]
                context_mask = so_api_mask[i:i + 1, :]
    ...
    def train(self,
        ...
        for epoch in range(num_train_epochs):
            ...
            for batch in bar:
                ...
                nb_tr_examples += so_api_ids.size(0)
                nb_tr_steps += 1
                loss.backward()
